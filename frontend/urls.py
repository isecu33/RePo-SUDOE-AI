...
urlpatterns = [
    ...
    path('api/download/<str:file_type>/<str:filename>/', views.download_file, name='download_file'),
    
    # Endpoint para servir archivos de output (PDBQT, logs, etc.)
    path('api/output/<str:filename>/', views.serve_output_file, name='serve_output_file'),

    # Endpoint para listar experimentos del usuario
    path('api/list-experiments/', views.list_user_experiments, name='list_user_experiments'),
    ...
    path('api/download-experiment/<str:experiment_key>/', views.download_experiment_zip, name='download_experiment_zip'),

    # Endpoint para obtener archivos del visualizador 3D
    path('api/get-visualizer-files/', views.get_visualizer_files, name='get_visualizer_files'),
    
    # Endpoints para gestión de experimentos en el visualizador
    path('api/get-available-experiments/', views.get_available_experiments, name='get_available_experiments'),
    path('api/get-specific-experiment/<str:experiment_key>/', views.get_specific_experiment, name='get_specific_experiment'),
