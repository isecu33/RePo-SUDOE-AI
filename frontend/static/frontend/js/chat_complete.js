            ...
            <div class="message-content">
                ...
                ">
                    <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 2px solid var(--border-color);">
                        ${getIcon('info', '', 24)}
                        <h3 style="margin: 0; font-size: 1.2rem; font-weight: 600; color: var(--text-primary);">Información Adicional del Experimento</h3>
                    </div>

                    <!-- Información del Experimento -->
                    <div style="margin-bottom: 1.5rem; padding: 1rem; background: var(--bg-tertiary); border-radius: 8px;">
                        <div style="font-size: 0.9rem; color: var(--text-secondary); margin-bottom: 0.5rem;">
                            <strong style="color: var(--text-primary);">Experimento:</strong>
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.75rem;">
                            ...
                            <h4 style="margin: 0; font-size: 1rem; font-weight: 600; color: var(--accent-color);">Fármaco: ${analysis.drug_name}</h4>
                        </div>
                        <div style="padding-left: 2rem; color: var(--text-primary);">
                            ${this.formatInfoField('Descripción', analysis.drug_description)}
                            ${this.formatInfoField('Indicaciones', analysis.drug_indications)}
                            ${this.formatInfoField('Estado', analysis.drug_status)}
                            ${this.formatInfoField('Fórmula Molecular', analysis.drug_molecular_formula)}
                            ${this.formatInfoField('Peso Molecular', analysis.drug_molecular_weight)}
                        </div>
                    </div>
                    ...
                    <div>
                        <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.75rem;">
                            <span style="font-size: 1.2rem;">[DNA]</span>
                            <h4 style="margin: 0; font-size: 1rem; font-weight: 600; color: var(--blue-color);">Gen/Proteína: ${analysis.gene_name}</h4>
                        </div>
                        <div style="padding-left: 2rem; color: var(--text-primary);">
                            ${this.formatInfoField('Nombre Completo', analysis.gene_full_name)}
                            ${this.formatInfoField('Función', analysis.gene_function)}
                            ${this.formatInfoField('Enfermedades Asociadas', analysis.gene_diseases)}
                            ${this.formatInfoField('Vías Moleculares', analysis.gene_pathways)}
                        </div>
                    </div>
                </div>
            </div>
