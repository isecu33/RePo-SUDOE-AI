...
class CustomUser(AbstractUser):
    ...
    institution = models.CharField(
        max_length=255, blank=True, verbose_name="Institution/Organization"
    )
    department = models.CharField(max_length=255, blank=True)
    position = models.CharField(
        max_length=255, blank=True, verbose_name="Position/Title"
    )
...
class AccessRequest(models.Model):
    ...
    user = models.OneToOneField(
        CustomUser, on_delete=models.CASCADE, related_name="access_request"
    )

    # Request Information
    purpose = models.CharField(
        max_length=20, choices=RESEARCH_PURPOSES, verbose_name="Research Purpose"
    )
    ...
    institutional_verification = models.TextField(
...
from django_cryptography.fields import encrypt  # noqa: E402
...
class UserProfile(models.Model):
    ...
    ollama_base_url = models.CharField(
        max_length=255, blank=True, default="", verbose_name="URL de Ollama"
    )
