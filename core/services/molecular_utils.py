...
class MolecularUtils:
    ...
    def download_and_load_molecule(estructura_info):
        ...
        try:
            ...
            if response.status_code != 200:
                print(f"No se pudo descargar la estructura. Status: {response.status_code}")
                return None
    ...
    @staticmethod
    def save_molecule_image(mol, filename="molecule.png", upload_path="molecular_images/"):
        """
    ...
    def process_uploaded_molecule(uploaded_file):
        ...
        try:
            ...
            if mol is None:
                return {
                    'success': False,
                    'error': 'No se pudo cargar la molécula'
                }
