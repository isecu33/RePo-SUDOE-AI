...
class ProteinDatabaseAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Structure Information", {"fields": ("pdb_codes",)}),
        (
...
class ConversationContextAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Parameters", {"fields": ("extracted_parameters", "available_structures")}),
        (
            "Metadata",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class MolecularQueryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Performance", {"fields": ("processing_time_ms", "openai_calls")}),
...
class StructureCacheAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Validation", {"fields": ("is_valid_structure", "validation_error")}),
        (
            "Cache Statistics",
            {"fields": ("downloaded_at", "last_accessed", "access_count")},
        ),
        ("Data", {"fields": ("structure_data",), "classes": ("collapse",)}),
    )
